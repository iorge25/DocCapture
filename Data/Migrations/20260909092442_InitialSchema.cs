        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Batches_FormTemplates_FormTemplateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FieldDefinitions_FormTemplates_FormTemplateId",
                        column: x => x.FormTemplateId,
                        principalTable: "FormTemplates",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BoundingBoxJson = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExtractedFields_FieldDefinitions_FieldDefinitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Batches_FormTemplateId",
                table: "Batches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtractedFields_DocumentId_FieldDefinitionId",
                table: "ExtractedFields",
                columns: new[] { "DocumentId", "FieldDefinitionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ExtractedFields_FieldDefinitionId",
                table: "ExtractedFields",
                column: "FieldDefinitionId");

            migrationBuilder.CreateIndex(
                name: "IX_FieldDefinitions_FormTemplateId",
